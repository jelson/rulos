...
Cell movie_idle[] = {{QUEISCE, "00000000"}, {20, "10100010"},      {50, "00000000"},
                     {20, "00101010"},      {QUEISCE, "00000000"}, {20, "01010101"},
                     {50, "00000000"},      {20, "05010003"},      {50, "00000000"},
                     {20, "00050200"},      {QUEISCE, "00000000"}, {20, "00011000"},
                     {50, "00000000"},      {20, "01003010"},      {50, "00000000"},
                     {20, "01000010"},      {END_SEQUENCE, NULL}};

#define ZAP_RATE 15
Cell movie_zap[] = {{ZAP_RATE, "00000001"}, {ZAP_RATE, "00000012"}, {ZAP_RATE, "00000123"},
                    {ZAP_RATE, "00001234"}, {ZAP_RATE, "00012345"}, {ZAP_RATE, "00123450"},
                    {ZAP_RATE, "01234500"}, {ZAP_RATE, "12345000"}, {ZAP_RATE, "23450000"},
                    {ZAP_RATE, "34500000"}, {ZAP_RATE, "45000000"}, {ZAP_RATE, "50000000"},
                    {END_SEQUENCE, NULL}};

#define THROB_RATE 50
Cell movie_diddle[] = {{THROB_RATE, "00011000"}, {THROB_RATE, "00122100"}, {THROB_RATE, "12344321"},
                       {THROB_RATE, "23455432"}, {THROB_RATE, "34500534"}, {THROB_RATE, "34500534"},
                       {THROB_RATE, "23455432"}, {THROB_RATE, "12344321"}, {THROB_RATE, "01233210"},
                       {THROB_RATE, "00122100"}, {THROB_RATE, "00011000"}, {END_SEQUENCE, NULL}};

static uint8_t _pwm_phases[16] = {0x3e, 0x3c, 0x38, 0x38, 0x30, 0x30, 0x30, 0x30,
