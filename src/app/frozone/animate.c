...
Cell movie_idle[] = {
    {QUEISCE, "00000000"}, {20, "10100010"},      {50, "00000000"},
...
#define ZAP_RATE 15
Cell movie_zap[] = {
    {ZAP_RATE, "00000001"}, {ZAP_RATE, "00000012"}, {ZAP_RATE, "00000123"},
...
Cell movie_diddle[] = {{THROB_RATE, "00011000"}, {THROB_RATE, "00122100"},
                       {THROB_RATE, "12344321"}, {THROB_RATE, "23455432"},
                       {THROB_RATE, "34500534"}, {THROB_RATE, "34500534"},
                       {THROB_RATE, "23455432"}, {THROB_RATE, "12344321"},
                       {THROB_RATE, "01233210"}, {THROB_RATE, "00122100"},
                       {THROB_RATE, "00011000"}, {END_SEQUENCE, NULL}};

static uint8_t _pwm_phases[16] = {0x3e, 0x3c, 0x38, 0x38, 0x30, 0x30,
                                  0x30, 0x30, 0x20, 0x20, 0x20, 0x20,
                                  0x20, 0x20, 0x20, 0x20};
